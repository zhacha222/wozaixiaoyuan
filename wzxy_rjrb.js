...
* 微信小程序：我在校园 日检日报
* 脚本说明：如果打卡不止两次，自己去修改改定时，在打卡时间段内运行该脚本即可
* 默认定时：默认每天 8点5分 和 16点5分 运行两次。
* cron: 5 8,16 * * *
* 变量名称：wzxy
* 变量值：  {
        "username": "手机号",
 ...
 ***更新日志：
 ...
 1.0.9 优化通知
 1.1.0 log增加新版本内容
 1.1.1 增加`仅通知打卡失败`模式，在脚本第58行修改开启
...
let update_data = "1.1.1 增加`仅通知打卡失败`模式，可在脚本第58行修改开启"; //新版本更新内容
//我在校园账号数据
